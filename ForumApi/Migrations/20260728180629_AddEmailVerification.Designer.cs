...
namespace ForumApi.Migrations
{
    ...
    [Migration("20260728180629_AddEmailVerification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForumApi.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ForumApi.Models.Badge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ForumApi.Models.SiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ForumApi.Models.AuditLog", b =>
                {
                    b.HasOne("ForumApi.Models.User", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("ForumApi.Models.Report", b =>
                {
                    b.HasOne("ForumApi.Models.User", "HandledBy")
                        .WithMany()
                        .HasForeignKey("HandledByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ForumApi.Models.User", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("ForumApi.Models.User", b =>
                {
                    b.HasOne("ForumApi.Models.Badge", "Badge")
                        .WithMany("Users")
